...
export default function AddUserPage() {
  ...
  const generateUsername = (firstName: string, lastName: string, studentNumber: string, className: string) => {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    setFormData(prev => {
      ...
      if (newData.role === 'student') {
        ...
        if (newData.firstName && newData.lastName && newData.studentNumber && className) {
