...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({ error: 'Kullanıcı alınırken bir hata oluştu' }, { status: 500 })
  }
}
...
export async function PUT(
  ...
  try {
    ...
    const { username, email, firstName, lastName, role, studentNumber } = await req.json()
